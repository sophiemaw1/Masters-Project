...
from complex_attn import ComplexMultiHeadDotProductAttention
from layers import dense_neuron
from layers import mlp5
...
class Sampling(nn.module.Module):
    ...
    def __call__(self, z_mean, z_log_var, key):
        ...
        return jax.lax.complex(sample[Ellipsis, 0], sample[Ellipsis, 1])
